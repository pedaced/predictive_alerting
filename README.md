...
## Incident Definition and Synthetic Data
...
## Feature Engineering: First Principles
...
### Interpretation
The model achieved an Average Precision (AP) of 0.79. The resulting Precision-Recall curve shows the model's capacity to identify incident signatures across varying confidence levels. At standard operating points, the system successfully distinguishes between seasonal noise and pre-failure signatures.

![Feature Importance](https://raw.githubusercontent.com/pedaced/predictive_alerting/main/images/feature_importance.png)

The Random Forest's ability to rank feature importance provides a key "Explainability Factor." It allows the system to provide context alongside an alert (e.g., "High probability of incident due to rising cpu_trend"). This transparency helps SRE teams trust the model and understand whether an alert is driven by load, volatility, or a sustained trend.
